...
input_data_file = "G:\\MO-PLM\\Transfer\\Open Sky Data Challenge\\Fuel Consumption\\fuel_train.csv"
flight_trajectories_folder = Path("G:\\MO-PLM\\Transfer\\Open Sky Data Challenge\\flights_train")

# input_data_file = "G:\\MO-PLM\\Transfer\\Open Sky Data Challenge\\Fuel Consumption\\fuel_rank_submission.csv"
# flight_trajectories_folder = Path("G:\\MO-PLM\\Transfer\\Open Sky Data Challenge\\flights_rank")

# input_data_file = Path("../data/fuel_valid.csv")
# flight_trajectories_folder = Path("../data/flights_train")
...
rmses = []
for flight_id, flight_input_df in input_df.groupby("flight_id"):
